package jgisson.spring.keycloak;

import jgisson.spring.keycloak.config.SpringKeycloakTutorialsSecurityConfiguration;
import jgisson.spring.keycloak.rest.SpringKeycloakTutorialsApisController;
 ...
 * <p>his class use {@link SpringKeycloakTutorialsSecurityConfiguration.CommonSpringTutorialsSecuritAdapter} which define all
 * security matchers</p>
 */
@TestConfiguration
@EnableWebSecurity
class SpringKeycloakTutorialsSecurityTestConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.apply(new SpringKeycloakTutorialsSecurityConfiguration.CommonSpringTutorialsSecuritAdapter());
    }
